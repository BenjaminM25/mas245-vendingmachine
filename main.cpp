...
#include <vendingmachine.h> // Include VendingMachine class header (makes class declaration visible).
...
int main()
{
    ...
    // Newly installed soda.
    Soda energidrikk("Energidrikk", 36, 7);
    Soda sjokomelk("Sjokomelk", 28, 5);
